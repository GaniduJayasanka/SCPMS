<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VMS_Login.aspx.cs" Inherits="SCPMS.VMS_Login" %>
...
<head>
    ...
    <!-- Google Font link for using 'Roboto' font family -->
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&display=swap" rel="stylesheet">
    
    <!-- Cascading Style Sheets Link -->
    <link rel="stylesheet" type="text/css" href="Css/VMSLogin.css">
...
<body>
    ...
    <!-- Main content section with two parts: Features and Login -->
        <div class="content">
            <div class="features">
                <img id="features-img" src="/Image/VMS.jpg" alt="Feature Image">
                <div class="features-content">
                    <h1 id="features-title">Visitor Management System</h1>
                </div>
            </div>
