    ...
    <div class="input-group">
        ...
        <asp:TextBox ID="txtPassword" CssClass="form-control" runat="server" TextMode="Password" placeholder="Password"></asp:TextBox>
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <asp:DropDownList ID="ddlUserRoles" CssClass="form-select" runat="server">
                                <asp:ListItem Text="Select User Role" Value=""></asp:ListItem>
                                <asp:ListItem Text="Admin" Value="Admin"></asp:ListItem>
                                <asp:ListItem Text="Standard User" Value="Standard User"></asp:ListItem>
                    ...
                    <div class="col-md-6 d-flex align-items-center">
                        <asp:CheckBox ID="chkActive" runat="server" CssClass="form-check-input me-2" Checked="true" />
            ...
            <div id="pnlSelectUser" runat="server" style="display: none;">
                <div class="input-group">
                    ...
                    <asp:Button ID="btnSelectUser" runat="server" CssClass="btn btn-primary" Text="Select" OnClick="btnSelectUser_Click" />
                </div>
            </div>
